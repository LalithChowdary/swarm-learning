...
export APLS_IP=192.168.29.154
export HOST_IP=192.168.29.238
export SN_IP=192.168.29.238
...
--cert=workspace/fraud-detection-skl/cert/swci-1-cert.pem --capath=workspace/fraud-detection-skl/cert/ca/capath --apls-ip=${APLS_IP} < /dev/null 2>&1 | tee workspace/swci_output.log
